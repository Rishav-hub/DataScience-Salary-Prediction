...
from salary.entity.config_entity import DataIngestionConfig, DataTransformationConfig,DataValidationConfig,   \
ModelTrainerConfig,ModelEvaluationConfig,ModelPusherConfig,TrainingPipelineConfig
from salary.util.util import read_yaml_file
...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        """This method is used to get the data ingestion config from the config file

        Raises:
            SalaryException: If any exception occurs Custom exception is raised

        Returns:
            DataIngestionConfig: Named tuple of data ingestion config
        """
        try:
